const StarBorder = ({
  ...
  return (
    ...
    >
      ...
      />
      <div className="relative z-1 bg-gradient-to-b from-slate-900 to-slate-950 border border-white/10 text-white text-center text-[16px] py-[16px] px-[26px] rounded-[20px]">
        {children}
      </div>
    </Component>
  );
